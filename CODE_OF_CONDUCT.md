...
Janook is scientific software, and disagreement about interpretation is expected and welcome.
Arguing that a criterion has been implemented incorrectly, that a classification is wrong, or that a
design decision is mistaken is not a conduct problem — it is the work. Bring evidence, and expect to
be asked for it.

What is not welcome is directing that at a person rather than at the argument.
...
This project is currently maintained by one person, so a report will be read by the maintainer. If
your report concerns the maintainer, or you would prefer it not go to them, say so in your message
and it will be referred to an uninvolved third party before any action is taken.
